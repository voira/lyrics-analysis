...
new_stop_words <- c('ooh', 'yeah', 'hey', 'whoa', 'woah', 'ohh', 'was', 'mmm', 'oooh', 'yah', 'yeh', 'hmm', 'deh', 'doh', 'and', 'yes', 'can', 'And', 'the', 'the', 'but', 'ayy', 'doo', 'let', 'Let', 'huh', 'dit', 'dat', 'wit', 'ain', 'll', 've', 're', 'isn', 't', 's', 'd', 'm', 'woah', 'uh', 'na', "I'm", "I'll", "ain't", "mai", "get", "sai", "wai", "like", "it'", "cau", 'one', 'two', 'three', 'four', 'que', 'choo', 'chh', 'nah', 'boaw', 'ody', 'oop', 'ron', 'woo', 'aye', 'wee', "get", "got", "have", "just", "wanna", "gotta", "y'all", "really", "even", "gon", "now")
